...
#include <jni.h>
/* Header for class com_polysfactory_n3_jni_N3 */

#ifndef _Included_com_polysfactory_n3_jni_N3
#define _Included_com_polysfactory_n3_jni_N3
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_polysfactory_n3_jni_N3
